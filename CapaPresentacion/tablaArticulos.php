        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a  href="<?php echo "./log_eliminarArt.php?id_art=" .  $dato[0];?>" onclick="return confirm('Are you sure to delete this Article?');"><i class="fa fa-trash fa-lg btn-outline-danger" aria-hidden="true"></i></a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
